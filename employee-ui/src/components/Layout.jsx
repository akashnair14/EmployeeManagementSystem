    ...
    return (
        <Box sx={{ display: "flex", flexDirection: "column", minHeight: "100vh" }}>
            ...
            >
                <Container maxWidth="xl">
                    <Box sx={{
                        ...
                        <Toolbar sx={{ justifyContent: "space-between", px: "0 !important", minHeight: "70px !important" }}>
                            {/* Logo */}
            ...
            <Box component="main" sx={{ flexGrow: 1, py: 6 }}>
                <Container maxWidth="xl">
                    <Box sx={{ mb: 6, opacity: 0, animation: "fadeIn 0.8s ease-out forwards", "@keyframes fadeIn": { "0%": { opacity: 0, transform: "translateY(10px)" }, "100%": { opacity: 1, transform: "translateY(0)" } } }}>
